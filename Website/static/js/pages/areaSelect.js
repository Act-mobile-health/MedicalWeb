var city = [
{
  ...
  { "name": "北京", "area": ["东城区", "西城区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云区", "延庆区"] }
...

{
  ...
  { "name": "钓鱼岛", "area": ["钓鱼岛"] }
	...
	var qu = document.getElementById("county");

	sheng.options[0] = new Option("请输入省");
	shi.options[0] = new Option("请输入市");
	qu.options[0] = new Option("请输入区");
	areaSelection(sheng, shi, qu);

	var sheng_h = document.getElementById("province_h");
	var shi_h = document.getElementById("city_h");
	var qu_h = document.getElementById("county_h");

	sheng_h.options[0] = new Option("请输入省");
	shi_h.options[0] = new Option("请输入市");
	qu_h.options[0] = new Option("请输入区");
	areaSelection(sheng_h, shi_h, qu_h);
